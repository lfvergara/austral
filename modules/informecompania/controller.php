<?php
require_once "modules/informecompania/model.php";
require_once "modules/informecompania/view.php";
require_once "modules/equipo/model.php";
require_once "modules/competencia/model.php";


class InformeCompaniaController {

	function __construct() {
		$this->model = new InformeCompania();
		$this->view = new InformeCompaniaView();
	}
	...
	function guardar_archivos() {
        ...
        $directorio_periodo = URL_PRIVATE . "informecompania/periodo{$periodo}/";
